...
import com.example.yummfoodapp.SummaryActivity;
...
public class CartAdapter extends CursorAdapter {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
       ...
       // totalPrice = totalPrice + Integer.parseInt(pricesofdrink.substring(1).trim());
        SummaryActivity.totalPrice = SummaryActivity.totalPrice + Integer.parseInt(pricesofdrink.substring(1).trim());
        ...
        orderList.add(new Order(nameofdrink,pricesofdrink,quantitysofdrink,yeshasCream,yeshastopping));
